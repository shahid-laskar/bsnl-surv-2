...
# Override sqlalchemy.url from env var (from .env via pydantic-settings)
DATABASE_URL = os.environ.get("DATABASE_URL", "")
if DATABASE_URL:
    # Convert asyncpg URL to standard for Alembic (Alembic uses sync for offline)
...
async def run_async_migrations() -> None:
    ...
    asyncpg is used here — the URL must use postgresql+asyncpg:// scheme.
    """
